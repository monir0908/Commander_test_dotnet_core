        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BatchHost_AspNetUsers_HostId",
                        column: x => x.HostId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BatchHost_Batch_BatchId",
                        column: x => x.BatchId,
                        principalTable: "Batch",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BatchHost_Project_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Project",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BatchHostParticipant", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BatchHostParticipant_AspNetUsers_HostId",
                        column: x => x.HostId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BatchHostParticipant_AspNetUsers_ParticipantId",
                        column: x => x.ParticipantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BatchHostParticipant_Batch_BatchId",
                        column: x => x.BatchId,
                        principalTable: "Batch",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BatchHostParticipant_Project_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Project",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BatchHost_BatchId",
                table: "BatchHost",
                column: "BatchId");

            migrationBuilder.CreateIndex(
                name: "IX_BatchHost_HostId",
                table: "BatchHost",
                column: "HostId");

            migrationBuilder.CreateIndex(
                name: "IX_BatchHost_ProjectId",
                table: "BatchHost",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_BatchHostParticipant_BatchId",
                table: "BatchHostParticipant",
                column: "BatchId");

            migrationBuilder.CreateIndex(
                name: "IX_BatchHostParticipant_HostId",
                table: "BatchHostParticipant",
                column: "HostId");

            migrationBuilder.CreateIndex(
                name: "IX_BatchHostParticipant_ParticipantId",
                table: "BatchHostParticipant",
                column: "ParticipantId");

            migrationBuilder.CreateIndex(
                name: "IX_BatchHostParticipant_ProjectId",
                table: "BatchHostParticipant",
                column: "ProjectId");
